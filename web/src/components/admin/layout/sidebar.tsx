...
import { pipelineApi } from '@/lib/admin/api';
...
const sections: NavSection[] = [
  ...
  },
  {
    label: 'Pipeline',
    items: [
      { name: 'Pipeline', href: '/admin/dashboard/pipeline', icon: GitBranch, badgeKey: 'processing' },
      { name: 'Channels', href: '/admin/dashboard/channels', icon: Radio },
      { name: 'Queue', href: '/admin/dashboard/queue', icon: ListOrdered },
      { name: 'Subscriptions', href: '/admin/dashboard/subscriptions', icon: Rss },
      { name: 'Deep Dive', href: '/admin/dashboard/deepdive', icon: Microscope },
    ],
  },
  {
    label: 'Insights',
    items: [
      ...
      { name: 'Verification', href: '/admin/dashboard/verification', icon: ShieldCheck },
      { name: 'Audit Log', href: '/admin/dashboard/audit', icon: FileSearch },
    ],
  },
  {
    label: 'System',
    items: [
      { name: 'System', href: '/admin/dashboard/system', icon: Activity },

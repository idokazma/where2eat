...
import { pipelineApi, subscriptionsApi } from '@/lib/admin/api';
...
import type { PipelineOverview, PipelineStats, QueueItem, HistoryItem, SubscriptionDetail } from '@/types/admin';
import { PipelineFlow } from '@/components/admin/pipeline/pipeline-flow';
import { NowProcessing } from '@/components/admin/pipeline/now-processing';
import { QueueTable } from '@/components/admin/pipeline/queue-table';
import { FailedItems } from '@/components/admin/pipeline/failed-items';
import { AnalyzeInput } from '@/components/admin/pipeline/analyze-input';
import { AllVideosTable } from '@/components/admin/pipeline/all-videos-table';
import { VideoDetailDialog } from '@/components/admin/pipeline/video-detail-dialog';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild variant="outline" size="sm">
            <Link href="/admin/dashboard/pipeline/logs">
      ...
      <Tabs defaultValue="all-videos" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="logs">
            <Link href="/admin/dashboard/pipeline/logs" className="flex items-center">
              Logs
            </Link>
          </TabsTrigger>
        </TabsList>

...
Manages OpenAI, Claude, and Gemini API configurations
"""
...
class LLMConfig:
    ...
    def from_env(cls) -> 'LLMConfig':
        ...
        # Get provider from env (default: gemini)
    ...
    def validate(self) -> None:
        ...
        if self.provider == "openai":
            ...
            raise ValueError(f"Invalid LLM provider: {self.provider}. Must be 'openai', 'claude', or 'gemini'.")

#!/usr/bin/env python3
"""
YouTube Channel Processing Script
Command-line interface for processing entire YouTube channels using the batch processor.
"""
...
from src.youtube_channel_collector import APIQuotaExceededError, ChannelNotFoundError


def parse_arguments():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(
        description='Process entire YouTube channels for restaurant discovery'
    )
...
def main():
    ...
    print("🚀 YouTube Channel Processing Script")
    print("=" * 50)
    ...
    try:
        ...
        print("🎯 Starting channel processing...")
        job = processor.start_channel_processing(
        ...
        print(f"📺 Channel: {job.channel_title}")
        ...
        if job.total_videos == 0:
            ...
            print("   Try adjusting your filters or check the channel URL.")
            sys.exit(0)
        ...
        print("")
        print("✅ Channel processing setup completed successfully!")
